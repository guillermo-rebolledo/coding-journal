...
| Medium   | In-flight actions replaced their names and lost useful focus state.    | Refresh and destructive actions keep stable accessible names, native focus, `aria-busy`, and duplicate-activation protection.                                    |
